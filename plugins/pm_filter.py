...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Please Search This Group 👉 https://t.me/All_Movies_Group_Movie</b>")
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/M_E_publisher")
                                ]
                                ]
                            )
                        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/M_E_publisher")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>Hᴇʏ {message.from_user.mention}, Hᴇʀᴇ ɪs Wʜᴀᴛ I Fᴏᴜɴᴅ Iɴ Mʏ Dᴀᴛᴀʙᴀsᴇ Fᴏʀ Yᴏᴜʀ Qᴜᴇʀʏ {search}. How To Download 👉 https://t.me/The_Publishers/117</b>"
